...
export enum LanguageEN {
    ...
    PROJECT_ACTIVATED_DESCRIPTION='Your project has been successfully re-enabled.',
    PROJECT_ACTIVATED_ERROR_DESCRIPTION='An error occurred while deleting your project.',
    PROJECTED_ACTIVATED_ERROR='Project could not be deleted',
    ...
    DELETE_PROJECT_DESCRIPTION='Are you sure you want to re-enable this project?',
    ACTIVATE_PROJECT='Activate project?',
    ACTIVATE_PROJECT_DESCRIPTION='Are you sure you want to re-enable this project?',
    YES='Yes',
    NO='No',
    ...
    PROJECT_REQ_ERR_TITLE='Please review the form',
    PROJECT_REQ_ERR_DESC='Required field missing',
    ...
    NO_PROJECTS_IN_ARCHIVE_TITLE="You don't have any archived projects",
    NO_PROJECTS_DESCRIPTION='Create your first project now!',
    DONT_HAVE_AN_ACCOUNT='Don\'t have an account?',
    SIGN_UP='Sign up',
    SEARCH='Search',
    SEARCH_PH='Search ..',
    SEARCH_PROJ_LABEL='Search for Projects'
}